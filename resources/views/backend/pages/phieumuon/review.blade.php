        ...
        <div class="print-conatainer">
            ...
            <div class="body">
                <div class = 'block'>
                    ...
                    <span>{{$phieumuon->docgia()->first()->hoTen}}</span>
                </div>

                <div class = 'block'>
                    <span class = 'title-ct'>Nhân viên:</span>
                    <span>{{$phieumuon->nhanvien()->first()->hoTen}}</span>
                </div>

                <div class = 'block'>
                    <span class = 'title-ct'>Mượn từ ngày:</span>
                    <span>{{$phieumuon->ngayMuon->format('d-m-Y')}}</span>
                    <span class = 'title-ct'>đến ngày:</span>
                    <span>{{$phieumuon->ngayHenTra->format('d-m-Y')}}</span>
                </div>

                <div class = 'block'>
                    <span class = 'title-ct'>Số lượng sách:</span>
                    <span>{{$phieumuon->soLuong}}</span>
                    <span>Cuốn</span>
                </div>

                <div class = 'block'>
                    <span class = 'title-ct'>Chi tiết phiếu mượn:</span>
                    <table class="table table-bordered " id='table-chitiet'>
                        ...
                        <tbody>
                              @foreach ($phieumuon->cuonsachs()->get() as $i)
                              <tr>
                                    <td class="txt-oflo">{{$i->hienThi}}</td>
                                    <td class="txt-oflo">{{$i->sach()->first()->tenSach}}</td>
                              </tr>
                              @endforeach
                        </tbody>
                    </table>
