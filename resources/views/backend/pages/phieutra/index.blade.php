...
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row bg-title">
            ...
            <a href="/admin/danhmuc/phieutra/create">
...
<script>
    ...
    var page = 1;
    const urlPhanTrang = "/admin/danhmuc/phieutra/phantrang?page=";
    const urlXoa  = "/admin/danhmuc/phieutra/";
    // Chay Phan trang 
    ...
    $(document).on('click', '.table .xoa', function () {
        var id = $(this).val();
        alertify.confirm("Bạn có muốn xóa phiếu trả này??",
            function () {
                $.ajaxSetup({
                    headers: {
