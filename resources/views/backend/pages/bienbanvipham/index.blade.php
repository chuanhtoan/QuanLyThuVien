...
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row bg-title">
            ...
            <a href="/admin/danhmuc/vipham/create">
        ...
        <div class="row">
            <div class="white-box">
                <div class="table-responsive" id="tb_tl">
                     ...
                     @include('backend.pages.bienbanvipham.phantrang',['arr'=>$arr,'page'=>1]) 
                </div>
            </div>
...
<script>
    ...
    var page = 1;
    const urlPhanTrang = "/admin/danhmuc/vipham/phantrang?page=";
    const urlXoa  = "/admin/danhmuc/vipham/";
    // Chay Phan trang 
