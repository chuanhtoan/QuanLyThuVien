...
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row bg-title">
            ...
            <a href="/admin/danhmuc/docgia/create">
...
<script>
    ...
    var page = 1;
    const urlPhanTrang = "/admin/danhmuc/docgia/phantrang?page=";
    const urlXoa  = "/admin/danhmuc/docgia/";
    // Chay Phan trang 
    ...
    $(document).on('click', '.table .xoa', function () {
        var id = $(this).val();
        alertify.confirm("Bạn có muốn xóa độc giả này??",
            function () {
                $.ajaxSetup({
                    headers: {
