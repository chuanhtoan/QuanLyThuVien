...
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row bg-title">
            ...
            <a href="/admin/danhmuc/phieudat/create">
        ...
        <div class="row">
            <div class="white-box">
                <div class="table-responsive" id="tb_tl">
                    @include('backend.pages.phieudat.phantrang',['arr'=>$arr])
                </div>
            </div>
...
<script>
    ...
    var page = 1;
    const urlPhanTrang = "/admin/danhmuc/phieudat/phantrang?page=";
    const urlXoa  = "/admin/danhmuc/phieudat/";
    // Chay Phan trang 
