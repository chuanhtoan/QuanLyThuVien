            ...
            <form id="phieumuonForm" action="{{route('phieudat.store')}}" method="post">
                ...
                <div>
                    ...
                    <input disabled type="date" class="form-control" required name="ngayMuon"
                     value="{{$phieudat->ngayLap->format('Y-m-d')}}" id="ngayMuon">
                </div>
                ...
                <div style="display: flex;">
                    ...
                    <div style="margin-top:2rem ;margin-right:1rem ; width: 40%;">
                        ...
                        <select class="form-control" id="selectNhanVien" name="selectNhanVien" required>
                            ...
                            <option
                               @if ($item->id == $phieudat->ID_NhanVien)
                                 selected
                               @endif   
                ...
                <div class="chitietphieumuon" style="margin-top: 5rem; ">
                    ...
                    <div class="table-responsive" id="tb_tl">
                        ...
                        <table class="table" id='table-chitiet'>
                            ...
                            <tbody>
                                  @foreach ($phieudat->cuonsachs()->get() as $i)
...
<script>
    ...
    $("#check").click(function () {
        ...
        var id = href.toString().split('phieudat/')[1].split('/')[0];
    ...
    $(document).on('click', '#table-chitiet .xoa', function (e) {
        var ma = $(this).val();
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response['yes'] == true) {
                    alertify.success('Sửa mượn thành công');
                }
            }
        });
    }
