...
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row bg-title">
            ...
            <a href="/admin/danhmuc/quyen/create">
        ...
        <div class="row">
            <div class="white-box">
                <div class="table-responsive" id="tb_tl">
                    ...
                    {{-- @include('backend.pages.quyen.phantrang',['arr'=>$arr]) --}}
                </div>
            </div>
...
<script>
    ...
    var page = 1;
    const urlPhanTrang = "/admin/danhmuc/quyen/phantrang?page=";
    const urlXoa  = "/admin/danhmuc/quyen/";
    // Chay Phan trang 
    ...
    $(document).on('click', '.table .xoa', function () {
        var id = $(this).val();
        alertify.confirm("Bạn có muốn xóa quyền này??",
            function () {
                $.ajaxSetup({
                    headers: {
