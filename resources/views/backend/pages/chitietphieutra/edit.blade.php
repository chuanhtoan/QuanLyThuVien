    ...
    <div class="container-fluid">
        ...
        <div class="white-box">
            <form id="chitietphieutraForm" action="{{route('chitietphieutra.store')}}" method="post">
                ...
                <div>
                    <label>Chi Tiết Phiếu Trả: {{$itemctpt->id}}</label>
                </div>
                ...
                <div class="text-center" style="margin-top: 5rem;">
                    ...
                    <a href="{{route('chitietphieutra.show',$itemctpt->ID_PhieuTra)}}"> <button type="button" class="btn btn-danger">Hủys</button></a>
                </div>
...
<script>
    ...
    $("#check").click(function () {
        ...
        var id =href.toString().split('chitietphieutra/')[1].split('/')[0] ;
        if (hl) {
            thucHienAjax(id);
        }
    });
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response.yes === true) {
                    alertify.success('Sửa chi tiết phiếu trả thành công');
                }
            }
        });
    }
