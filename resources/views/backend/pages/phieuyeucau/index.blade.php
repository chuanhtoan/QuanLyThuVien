...
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row bg-title">
            ...
            <a href="/admin/danhmuc/phieuyeucau/create">
        ...
        <div class="row">
            <div class="white-box">
                <div class="table-responsive" id="tb_tl">
                    @include('backend.pages.phieuyeucau.phantrang',['arr'=>$arr,'page'=>1])
                </div>
            </div>
...
<script>
    ...
    var page = 1;
    const urlPhanTrang = "/admin/danhmuc/phieuyeucau/phantrang?page=";
    const urlXoa  = "/admin/danhmuc/phieuyeucau/";
    // Chay Phan trang 
