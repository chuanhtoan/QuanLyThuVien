    ...
    <!-- Bootstrap Core CSS -->
    <link href="{{asset('backend/html/bootstrap/dist/css/bootstrap.min.css')}}" rel="stylesheet">
    <!-- Menu CSS -->
    ...
    <!-- animation CSS -->
    <link href="{{asset('backend/html/css/animate.css')}}" rel="stylesheet">
    <!-- Custom CSS -->
    <link href="{{asset('backend/html/css/style.css')}}" rel="stylesheet">
    <!-- color CSS -->
    <link href="{{asset('backend/html/css/colors/default.css')}}" id="theme" rel="stylesheet">
...
<![endif]-->
    ...
    {{-- MY CSS --}}
    <link rel="stylesheet" href="{{asset('font/myfont.css')}}">
